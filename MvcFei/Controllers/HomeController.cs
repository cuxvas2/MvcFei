...
namespace MvcFei.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //Usa LINQ para obtener la lista de carrereas
        ...
        public async Task<IActionResult> Create([Bind("AlumnoId,Nombre,FecchaIngreso,Carrera,Promedio")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AlumnoId,Nombre,FecchaIngreso,Carrera,Promedio")] Alumno alumno)
        {
